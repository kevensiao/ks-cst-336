    ...
    <body>
        ...
        <div id="list">
            ...
            else if ($_GET['name']!='')
            {
                ...
                if($_GET['price']!=''){
                    echo ' and price.';
                    $input = $dbConn->query('SELECT * FROM device WHERE deviceName LIKE \'%'. $_GET['name'] .'%\' OR deviceType LIKE \'%'. $_GET['name'] .'%\' ORDER BY price');
                } 
                else {
                    $input = $dbConn->query('SELECT * FROM device WHERE deviceName LIKE \'%'. $_GET['name'] .'%\' OR deviceType LIKE \'%'. $_GET['name'] .'%\' ORDER BY deviceName');
                }
            } 
